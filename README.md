...
**Status: Public alpha.** Most features work, but expect instability and frequent changes while the platform evolves.

Landing page: [haskou.github.io/pigeon-swarm](https://haskou.github.io/pigeon-swarm/)

<p align="center">
  <img src="./docs/assets/landing-desktop-call-one-camera.png" alt="Pigeon Swarm desktop interface showing channels, a conversation, members, and an active voice call">
</p>
